...
FlaskDurationInit[2] := 4800
FlaskDurationInit[3] := 4800
FlaskDurationInit[4] := 6000
FlaskDurationInit[5] := 4800
FlaskDurationInit["r"] := 0     ; I use Steelskin here
FlaskDurationInit["t"] := 7000	; I use Molten Shell here
...
~r::
	; pass-thru and start timer for buff on r
...
~t::
	; pass-thru and start timer for buff on t
	FlaskLastUsed["t"] := A_TickCount
	Random, VariableDelay, -99, 99
	FlaskDuration["t"] := FlaskDurationInit["t"] + VariableDelay ; randomize duration to simulate human
	return
